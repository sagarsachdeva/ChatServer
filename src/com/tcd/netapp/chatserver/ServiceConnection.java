...
import com.tcd.netapp.chatserver.messages.input.DisconnectRoomRequest;
import com.tcd.netapp.chatserver.messages.input.JoinChatRequest;
import com.tcd.netapp.chatserver.messages.input.LeaveRoomRequest;
import com.tcd.netapp.chatserver.messages.input.MessageInput;
...
public class ServiceConnection extends Thread {
		...
		try {
			...
			while (true) {
				...
				case 2:
					...
					break;
				case 3:
					// disconnect client**remove all room refs
					for (int key : myChatRooms.keySet()) {
	...
	// System.out.println(decodeMessage("CHAT: 1\nJOIN_ID: 11\nCLIENT_NAME:
	// abc\nMESSAGE: abc\n"));
	// }
